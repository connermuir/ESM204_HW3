...
# "Welfare" for high income intiially is same as CS since there is no externality/tax for them. 
...
**A:** The amount of electricity produced/consumed *decreases* by `r round(demand_change, 0)`kWh. The new total consumption is `r round(q_new, 0)`
...
**D:** The welfare of low-income consumers *decreases* by $`r round(welfare_low_change, 0)`. *Note: welfare was already negative for low-income consumers if we assume they bear the full enviuronmental cost associated with electricity production.*
